...
namespace XueQiaoWaf.Trade.Modules.Applications.ViewModels
{
    ...
    public class OrderListParkedPageViewModel : ViewModel<IOrderListParkedPageView>
    {
        private readonly OrderItemsService orderItemsService;

        [ImportingConstructor]
        public OrderListParkedPageViewModel(IOrderListParkedPageView view,
        ...
        {            
            ...
            OrderListCollectionView.Filter = compositFilter;
