...
namespace XueQiaoWaf.Trade.Modules.Applications.ViewModels
{
    ...
    public class PositionOfContractViewModel : ViewModel<IPositionOfContractView>
    {
        ...
        protected PositionOfContractViewModel(IPositionOfContractView view,
        ...
        {
            var isContractTypeFilter = new Predicate<TargetPositionDataModel>(position => position.TargetType == ClientXQOrderTargetType.CONTRACT_TARGET);
            ...
            PositionCollectionView.Filter = new Predicate<object>(obj =>
            {
                ...
                if (!isContractTypeFilter.Invoke(position)) return false;
