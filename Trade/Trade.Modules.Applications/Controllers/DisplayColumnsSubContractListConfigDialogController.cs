...
namespace XueQiaoWaf.Trade.Modules.Applications.Controllers
{
    ...
    internal class DisplayColumnsSubContractListConfigDialogController : IController
    {
        private readonly IMessageWindowService messageWindowService;
        private readonly IEventAggregator eventAggregator;
        private readonly ITradeModuleService tradeModuleService;
        private readonly Lazy<ILoginUserManageService> loginUserManageService;
        private readonly DisplayColumnsSubContractListConfigItemsContainerModel configItemsContainerModel;
        ...
        public DisplayColumnsSubContractListConfigDialogController(IMessageWindowService messageWindowService,
            IEventAggregator eventAggregator,
            ITradeModuleService tradeModuleService,
            Lazy<ILoginUserManageService> loginUserManageService,
            DisplayColumnsSubContractListConfigItemsContainerModel configItemsContainerModel,
        ...
        public void Initialize()
        {
            ...
            dialogContentViewModel.ApplyAsGlobalText = "应用到全部合约列表";
        ...
        public void Run()
        {
            configureDialog = messageWindowService.CreateContentCustomWindow(DialogOwner, null, null, true, false, 
                true, "合约列表列配置", dialogContentViewModel.View);
        ...
        private void DisplayColumnsConfigItemsReset(IEnumerable<ListColumnInfo> toDisplayColumnInfos)
        {
            ...
            var allColumnsNames = Enum.GetNames(typeof(SubscribeContractListDisplayColumn));
            var notDisplayColumnCodes = allColumnsNames
                .Select(n => 
                {
                    Enum.TryParse(n, out SubscribeContractListDisplayColumn column);
        ...
        private void SaveConfiguration()
        {
            ...
            if (dialogContentViewModel.IsApplyAsGlobal)
            {
                ...
                if (dataRoot != null)
                {
                    dataRoot.GlobalAppliedContractListDisplayColumns
                        = configuredColumns.Select(i => (ListColumnInfo)i.Clone()).ToArray();
                }
                // 发布一个事件
                eventAggregator.GetEvent<GlobalApplyContractListDisplayColumnsEvent>().Publish(configuredColumns);
            }
