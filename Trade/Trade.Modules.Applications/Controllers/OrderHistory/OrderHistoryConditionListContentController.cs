...
namespace XueQiaoWaf.Trade.Modules.Applications.Controllers
{
    ...
    internal class OrderHistoryConditionListContentController : IOrderHistoryListContentController
    {
        private readonly OrderHistoryConditionListVM listViewModel;
        ...
        public OrderHistoryConditionListContentController(OrderHistoryConditionListVM listViewModel,
        ...
        {
            var historyList = OrderHistoryListFactory?.Invoke(this)?.OfType<OrderItemDataModel_Condition>().ToArray();
