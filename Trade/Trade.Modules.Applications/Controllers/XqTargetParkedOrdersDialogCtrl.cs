...
namespace XueQiaoWaf.Trade.Modules.Applications.Controllers
{
    ...
    internal class XqTargetParkedOrdersDialogCtrl : IController
    {
        private readonly XqTargetParkedOrdersVM contentVM;
        ...
        public XqTargetParkedOrdersDialogCtrl(XqTargetParkedOrdersVM contentVM,
