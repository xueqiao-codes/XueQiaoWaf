...
namespace XueQiaoWaf.Trade.Modules.Applications.DataModels
{
    ...
    /// 组合买入止盈单类型的下单视图创建剧本
    /// </summary>
    public class PlaceOrderViewCreateDrama_ComposeStopProfitBuy : PlaceOrderViewCreateDramaXQComposeBase
    {
        public PlaceOrderViewCreateDrama_ComposeStopProfitBuy() : base(ClientPlaceOrderType.BUY_STOP_PROFIT)
        {
        }
