...
namespace XueQiaoWaf.Trade.Modules.Applications.DataModels
{
    ...
    /// 组合卖出止损单类型的下单视图创建剧本
    /// </summary>
    public class PlaceOrderViewCreateDrama_ComposeStopLostSell : PlaceOrderViewCreateDramaXQComposeBase
    {
        public PlaceOrderViewCreateDrama_ComposeStopLostSell() : base(ClientPlaceOrderType.SELL_STOP_LOST)
        {
        }
