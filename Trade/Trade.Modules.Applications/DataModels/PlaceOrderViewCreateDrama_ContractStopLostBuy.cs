...
namespace XueQiaoWaf.Trade.Modules.Applications.DataModels
{
    ...
    /// 合约买入止损单类型的下单视图创建剧本
    /// </summary>
    public class PlaceOrderViewCreateDrama_ContractStopLostBuy : PlaceOrderViewCreateDramaBase
    {
        public PlaceOrderViewCreateDrama_ContractStopLostBuy() 
            : base(ClientPlaceOrderType.BUY_STOP_LOST, ClientXQOrderTargetType.CONTRACT_TARGET)
        {
        }
            ...
            HostingXQTradeDirection orderDirection)
        {
            ...
            condOrder.Label = HostingXQConditionOrderLabel.LABEL_STOP_LOST_BUY;
