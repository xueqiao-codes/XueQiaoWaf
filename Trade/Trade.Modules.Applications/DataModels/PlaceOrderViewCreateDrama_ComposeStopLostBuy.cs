...
namespace XueQiaoWaf.Trade.Modules.Applications.DataModels
{
    ...
    /// 组合买入止损单类型的下单视图创建剧本
    /// </summary>
    public class PlaceOrderViewCreateDrama_ComposeStopLostBuy : PlaceOrderViewCreateDramaXQComposeBase
    {
        public PlaceOrderViewCreateDrama_ComposeStopLostBuy() : base(ClientPlaceOrderType.BUY_STOP_LOST)
        {
        }
