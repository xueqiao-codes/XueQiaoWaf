...
namespace XueQiaoWaf.Trade.Modules.Applications.DataModels
{
    ...
    /// 合约卖出止损单类型的下单视图创建剧本
    /// </summary>
    public class PlaceOrderViewCreateDrama_ContractStopLostSell : PlaceOrderViewCreateDramaBase
    {
        public PlaceOrderViewCreateDrama_ContractStopLostSell() 
            : base(ClientPlaceOrderType.SELL_STOP_LOST, ClientXQOrderTargetType.CONTRACT_TARGET)
        {
        }
            ...
            HostingXQTradeDirection orderDirection)
        {
            ...
            condOrder.Label = HostingXQConditionOrderLabel.LABEL_STOP_LOST_SELL;
