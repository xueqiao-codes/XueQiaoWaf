...
#define MyAppName "XueQiaoTouyan"
#define MyAppDisplayName "雪橇投研"
#define MyAppPublisher "XueQiao"
#define MyAppURL "http://www.xueqiao.cn/"
#define MyAppGroupName "XueQiao"
#define MyAppExeName "XueQiaoTouyan.exe"
...
; 默认安装目录为 C: 盘根目录。不设置为 Program Files，因为 Program Files 目录对于文件写权限做了限定会导致无权限创建文件。项目在运行过程中需要在安装目录中创建一些文件
