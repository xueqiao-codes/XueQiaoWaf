...
namespace BolapanControl.ItemsFilter.View
{
    ...
    public class MultiValueFilterView : FilterViewBase<IMultiValueFilter>
    {
        ...
        public static readonly DependencyProperty ValueItemTemplateProperty =
            DependencyProperty.Register("ValueItemTemplate", typeof(DataTemplate), typeof(MultiValueFilterView), new PropertyMetadata(null));

        /// <summary>
        /// Get or set the value item template display in MultiValueFilterView, its container type is ListBoxItem
        /// </summary>
