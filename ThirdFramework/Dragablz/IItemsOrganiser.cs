...
namespace Dragablz
{
    public interface IItemsOrganiser
    {
        ...
        void OrganiseOnDragCompleted(DragablzItemsControl requestor, Size measureBounds, IEnumerable<DragablzItem> siblingItems, DragablzItem dragItem, double? dragItemHorizontalChange, double? dragItemVerticalChange);        
