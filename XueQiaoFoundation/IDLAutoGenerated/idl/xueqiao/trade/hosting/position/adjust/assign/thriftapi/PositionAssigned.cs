...
namespace xueqiao.trade.hosting.position.adjust.assign.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class PositionAssigned : TBase, INotifyPropertyChanged
  {
    ...
    /// <summary>
    /// 
    /// <seealso cref="PositionDirection"/>
    /// </summary>
    ...
    public void Read (TProtocol iprot)
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 12:
            if (field.Type == TType.I32) {
              PositionDirection = (PositionDirection)iprot.ReadI32();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("PositionAssigned");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("PositionAssigned(");
      sb.Append("AssignId: ");
      sb.Append(AssignId);
