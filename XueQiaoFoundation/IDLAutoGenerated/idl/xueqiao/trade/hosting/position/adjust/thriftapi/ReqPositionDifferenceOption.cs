...
namespace xueqiao.trade.hosting.position.adjust.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class ReqPositionDifferenceOption : TBase, INotifyPropertyChanged
  {
    ...
    public ReqPositionDifferenceOption() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ReqPositionDifferenceOption");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("ReqPositionDifferenceOption(");
      sb.Append("VerifyId: ");
      sb.Append(VerifyId);
