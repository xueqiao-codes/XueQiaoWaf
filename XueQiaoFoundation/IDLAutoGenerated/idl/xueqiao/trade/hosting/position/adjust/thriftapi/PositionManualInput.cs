...
namespace xueqiao.trade.hosting.position.adjust.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class PositionManualInput : TBase, INotifyPropertyChanged
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("PositionManualInput");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("PositionManualInput(");
      sb.Append("InputId: ");
      sb.Append(InputId);
      sb.Append(",SubUserId: ");
      sb.Append(SubUserId);
