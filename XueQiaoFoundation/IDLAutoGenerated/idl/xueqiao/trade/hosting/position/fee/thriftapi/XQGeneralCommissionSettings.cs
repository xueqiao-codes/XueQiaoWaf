...
namespace xueqiao.trade.hosting.position.fee.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class XQGeneralCommissionSettings : TBase, INotifyPropertyChanged
  {
    ...
    private CommissionInfo _commissionDelta;
    ...
    public CommissionInfo CommissionDelta
    {
      get
      {
        return _commissionDelta;
      }
      set
      {
        __isset.commissionDelta = true;
        SetProperty(ref _commissionDelta, value);
      }
    }
        ...
        switch (field.ID)
        {
          ...
          case 10:
            if (field.Type == TType.Struct) {
              CommissionDelta = new CommissionInfo();
              CommissionDelta.Read(iprot);
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("XQGeneralCommissionSettings");
      ...
      if (CommissionDelta != null && __isset.commissionDelta) {
        field.Name = "commissionDelta";
        field.Type = TType.Struct;
        field.ID = 10;
        oprot.WriteFieldBegin(field);
        CommissionDelta.Write(oprot);
        oprot.WriteFieldEnd();
      }
      if (__isset.isSync) {
        field.Name = "isSync";
    ...
    public override string ToString() {
      ...
      sb.Append(CommissionDelta== null ? "<null>" : CommissionDelta.ToString());
      sb.Append(",IsSync: ");
      sb.Append(IsSync);
