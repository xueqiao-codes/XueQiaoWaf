...
namespace xueqiao.trade.hosting.position.statis
{
  ...
  [Serializable]
  #endif
  public partial class StatPositionSummaryEx : TBase, INotifyPropertyChanged
  {
    ...
    private StatPositionSummary _positionSummary;
    private StatPositionDynamicInfo _positionDynamicInfo;
    ...
    public StatPositionSummary PositionSummary
    {
      get
      {
      ...
      set
      {
        __isset.positionSummary = true;
        SetProperty(ref _positionSummary, value);
      }
    }

    public StatPositionDynamicInfo PositionDynamicInfo
    {
      get
      {
        return _positionDynamicInfo;
      }
      set
      {
        __isset.positionDynamicInfo = true;
        SetProperty(ref _positionDynamicInfo, value);
      }
    }
    ...
    public struct Isset {
      ...
      public bool positionSummary;
      public bool positionDynamicInfo;
    }
        ...
        switch (field.ID)
        {
          ...
          case 5:
            if (field.Type == TType.Struct) {
              PositionSummary = new StatPositionSummary();
              PositionSummary.Read(iprot);
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
          case 6:
            if (field.Type == TType.Struct) {
              PositionDynamicInfo = new StatPositionDynamicInfo();
              PositionDynamicInfo.Read(iprot);
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("StatPositionSummaryEx");
      ...
      if (PositionSummary != null && __isset.positionSummary) {
        field.Name = "positionSummary";
        field.Type = TType.Struct;
        field.ID = 5;
        oprot.WriteFieldBegin(field);
        PositionSummary.Write(oprot);
        oprot.WriteFieldEnd();
      }
      if (PositionDynamicInfo != null && __isset.positionDynamicInfo) {
        field.Name = "positionDynamicInfo";
        field.Type = TType.Struct;
        field.ID = 6;
        oprot.WriteFieldBegin(field);
        PositionDynamicInfo.Write(oprot);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      ...
      sb.Append(PositionSummary== null ? "<null>" : PositionSummary.ToString());
      sb.Append(",PositionDynamicInfo: ");
      sb.Append(PositionDynamicInfo== null ? "<null>" : PositionDynamicInfo.ToString());
      sb.Append(")");
      return sb.ToString();
    }
