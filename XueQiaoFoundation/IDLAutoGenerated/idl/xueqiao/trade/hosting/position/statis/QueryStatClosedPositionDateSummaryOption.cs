...
namespace xueqiao.trade.hosting.position.statis
{
  ...
  [Serializable]
  #endif
  public partial class QueryStatClosedPositionDateSummaryOption : TBase, INotifyPropertyChanged
  {
    ...
    public QueryStatClosedPositionDateSummaryOption() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("QueryStatClosedPositionDateSummaryOption");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("QueryStatClosedPositionDateSummaryOption(");
