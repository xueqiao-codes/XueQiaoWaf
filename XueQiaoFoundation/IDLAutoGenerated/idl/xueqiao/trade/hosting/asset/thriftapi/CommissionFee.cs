...
namespace xueqiao.trade.hosting.asset.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class CommissionFee : TBase, INotifyPropertyChanged
  {
    ...
    public double CurrencyRate
    {
      ...
      set
      {
        __isset.currencyRate = true;
        SetProperty(ref _currencyRate, value);
      }
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("CommissionFee");
      ...
      if (__isset.currencyRate) {
        field.Name = "currencyRate";
        field.Type = TType.Double;
        field.ID = 9;
        oprot.WriteFieldBegin(field);
        oprot.WriteDouble(CurrencyRate);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("CommissionFee(");
