...
namespace xueqiao.trade.hosting.asset.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class ReqTradeAccountPositionTradeDetailOption : TBase, INotifyPropertyChanged
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ReqTradeAccountPositionTradeDetailOption");
