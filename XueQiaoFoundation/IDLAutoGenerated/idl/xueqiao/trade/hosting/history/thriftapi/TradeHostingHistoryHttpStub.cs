...
{
    public class TradeHostingHistoryHttpStub
    {
        public string Servant { get; private set; }

        public TradeHostingHistoryHttpStub (string servant)
        {
        ...
        public IInterfaceInteractResponse clearAll(StubInterfaceInteractParams interactParams = null)
        {
            ...
            try
            {
                ...
                var client = new TradeHostingHistory.Client(protocol);
                transport.Open();
        ...
        public async Task<IInterfaceInteractResponse<HostingXQOrderHisIndexPage>> getXQOrderHisIndexPageAsync(QueryXQOrderHisIndexItemOption qryOption, IndexedPageOption pageOption, CancellationToken cancellationToken, StubInterfaceInteractParams interactParams = null)
        {
            return await StubInterfaceInteractManager.SharedInstance.StartTaskAsync(
            () => getXQOrderHisIndexPage(qryOption, pageOption, interactParams),
            cancellationToken);
        }

        public IInterfaceInteractResponse<HostingXQOrderHisIndexPage> getXQOrderHisIndexPage(QueryXQOrderHisIndexItemOption qryOption, IndexedPageOption pageOption, StubInterfaceInteractParams interactParams = null)
        {
            var requestBeginTimestampMS = StubInterfaceInteractManager.NowUnixTimeSpan().TotalMilliseconds;
            string servant = Servant;
            string interfaceName = "getXQOrderHisIndexPage";
            ...
            HostingXQOrderHisIndexPage result = null;;
            Exception sourceExp = null;
            bool hasTransportExp = false;
            int? httpResponseStatusCode = null;
            var transport = StubInterfaceInteractManager.SharedInstance.GetTransportForService(Servant, interactParams, out string serviceAccessUrl);
        ...
        public async Task<IInterfaceInteractResponse<HostingXQTradeHisIndexPage>> getXQTradeHisIndexPageAsync(QueryXQTradeHisIndexItemOption qryOption, IndexedPageOption pageOption, CancellationToken cancellationToken, StubInterfaceInteractParams interactParams = null)
        {
            return await StubInterfaceInteractManager.SharedInstance.StartTaskAsync(
            () => getXQTradeHisIndexPage(qryOption, pageOption, interactParams),
            cancellationToken);
        }

        public IInterfaceInteractResponse<HostingXQTradeHisIndexPage> getXQTradeHisIndexPage(QueryXQTradeHisIndexItemOption qryOption, IndexedPageOption pageOption, StubInterfaceInteractParams interactParams = null)
        {
            var requestBeginTimestampMS = StubInterfaceInteractManager.NowUnixTimeSpan().TotalMilliseconds;
            string servant = Servant;
            string interfaceName = "getXQTradeHisIndexPage";
            ...
            argsList.Add(new Tuple<string, object>("qryOption", qryOption));
            argsList.Add(new Tuple<string, object>("pageOption", pageOption));
            HostingXQTradeHisIndexPage result = null;;
            Exception sourceExp = null;
            bool hasTransportExp = false;
            int? httpResponseStatusCode = null;
            var transport = StubInterfaceInteractManager.SharedInstance.GetTransportForService(Servant, interactParams, out string serviceAccessUrl);
