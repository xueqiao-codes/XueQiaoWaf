...
namespace xueqiao.trade.hosting.arbitrage.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class HostingXQComposeLimitOrderDetail : TBase, INotifyPropertyChanged
  {
    ...
    private HostingXQComposeLimitOrderExecParams _execParams;
    ...
    public HostingXQComposeLimitOrderExecParams ExecParams
    {
      get
      {
        return _execParams;
      ...
      set
      {
        __isset.execParams = true;
        SetProperty(ref _execParams, value);
      }
    }
    ...
    public void Read (TProtocol iprot)
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 5:
            if (field.Type == TType.Struct) {
              ExecParams = new HostingXQComposeLimitOrderExecParams();
              ExecParams.Read(iprot);
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("HostingXQComposeLimitOrderDetail");
      ...
      if (ExecParams != null && __isset.execParams) {
        field.Name = "execParams";
        field.Type = TType.Struct;
        field.ID = 5;
        oprot.WriteFieldBegin(field);
        ExecParams.Write(oprot);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      ...
      sb.Append(ExecParams== null ? "<null>" : ExecParams.ToString());
      sb.Append(")");
      return sb.ToString();
    }
