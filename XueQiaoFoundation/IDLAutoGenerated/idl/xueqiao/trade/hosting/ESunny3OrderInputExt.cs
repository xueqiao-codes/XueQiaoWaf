...
namespace xueqiao.trade.hosting
{
  ...
  [Serializable]
  #endif
  public partial class ESunny3OrderInputExt : TBase, INotifyPropertyChanged
  {
    ...
    private ESunny3ContractSummary _contractSummary;

    public ESunny3ContractSummary ContractSummary
    {
      get
      {
        ...
        switch (field.ID)
        {
          case 1:
            if (field.Type == TType.Struct) {
              ContractSummary = new ESunny3ContractSummary();
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ESunny3OrderInputExt");
