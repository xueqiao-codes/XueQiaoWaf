...
namespace xueqiao.trade.hosting
{
  ...
  [Serializable]
  #endif
  public partial class HostingSession : TBase, INotifyPropertyChanged
  {
    ...
    public string LoginIP
    {
      ...
      set
      {
        ...
        SetProperty(ref _loginIP, value);
      }
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("HostingSession");
      ...
      if (LoginIP != null && __isset.loginIP) {
        field.Name = "loginIP";
        field.Type = TType.String;
        field.ID = 4;
        oprot.WriteFieldBegin(field);
        oprot.WriteString(LoginIP);
        oprot.WriteFieldEnd();
      }
