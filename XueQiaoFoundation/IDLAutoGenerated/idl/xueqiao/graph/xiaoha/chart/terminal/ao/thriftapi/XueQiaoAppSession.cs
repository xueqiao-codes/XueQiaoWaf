...
namespace xueqiao.graph.xiaoha.chart.terminal.ao.thriftapi
{
  ...
  [Serializable]
  #endif
  public partial class XueQiaoAppSession : TBase, INotifyPropertyChanged
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("XueQiaoAppSession");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("XueQiaoAppSession(");
      sb.Append("MachineId: ");
      sb.Append(MachineId);
      sb.Append(",SubUserId: ");
      sb.Append(SubUserId);
